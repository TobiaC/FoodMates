...
public class RicetteFavoritesFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        recipes.add(new Recipe("Pollo al miele","30-40 min"));
        recipes.add(new Recipe("Pasticcio","30-40 min"));
        recipes.add(new Recipe("Pizza","30-40 min"));
        recipes.add(new Recipe("Torta al cioccolato","30-40 min"));
        recipes.add(new Recipe("Biscotti alle mandorle","30-40 min"));
        recipes.add(new Recipe("Pollo al miele","30-40 min"));
        recipes.add(new Recipe("Pasticcio","30-40 min"));
        recipes.add(new Recipe("Pizza","30-40 min"));
        recipes.add(new Recipe("Torta al cioccolato","30-40 min"));
